...
about_me = "My name is Matthew Bressler and I am pursuing a bachelor's degree in Computer Science at Georgia Tech. I have concentrations in intelligence and modeling/simulation and am also minoring in Economics. I'm interested in data science/analytics, machine learning, and software engineering. I am also very passionate about baseball analytics. I am currently an analyst for the DI baseball team at Georgia Tech. Prior to that, I was a three year varsity player at Adlai E. Stevenson High School where I was a captain and helped lead my team to a top 8 appearance in the IHSA State Playoffs."
...
experience_data = {
    "Georgia Tech Baseball Analyst": ([" - Develop a Stuff+ model for pitchers using Trackman data", 
                                       "- Analyze data on TruMedia to optimize defensive positioning and create positioning cards",
                                       "- Create visualizations and models to help coaches better understand pitching and hitting statistics", 
                                       "-  Manage in-game data tagging and technology operations via Trackman"], "images/GT_Headshot.JPG"),
    "MVP Sports Baseball Development and Analytics Coach": (["- Analyze pitching data (HB, IVB, tilt) and video from 20+ high school baseball players using Rapsodo technology", 
                                                             "- Teach players how to use tools (bands, weighted balls, Core Velo Belt) to improve arm care and throwing velocity", 
                                                             "- Work with coaches to personalize training and identify areas of improvement for players based on analysis"],"images/Velo.jpg")
}

projects_data = {
  "CSAS Baseball Data Challenge": [
    "- Leading a team conducting analysis on bat speed and swing length data",
    "- Developing visualizations using Matplotlib and Seaborn to identify patterns in pitcher-batter interaction"
  ],
  "MVP Sports Velocity Camp Dashboard": [
...
leadership_data = {
    ...
    "Stevenson Varsity Baseball Captain": (["- Collaborated with coaches to create and execute practice plans, organize team events, and promote a team culture", "- Mentored 60+ players in the program, guiding underclassmen and fostering leadership within the program", "- Led team to a top 8 finish in the IHSA playoffs through leadership and on-field performance"],"images/UnionCity2B.JPG")
